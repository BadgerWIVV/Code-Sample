...
#Recieve user input...Add these in while loop to ensure numbers.
Number_of_ETGs <- ginput("Enter the Number of ETGs you wish to include(5-30):")
Number_of_Systems<- ginput("Enter the Number of Systems you wish to include(5-70):")
Quantity_Filter<-ginput("Enter the minimum number of episodes for each ETG (I recommend 30):")

#Ensure numbers to prevent SQL injection
